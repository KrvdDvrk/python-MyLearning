...
EMOJIS = {"posicao_correta": "😆", "letra_correta": "❤️", "letra_errada": "💔"}
...
def letra_errada(letra):
    return f"[black on red]{letra}[/]"


MENSAGEM = (
    f'{posicao_correta("Boas vindas ")}' f'{letra_correta("ao ")}' f'{letra_errada("Pylavras!")}'
)


INSTRUCAO = "Advinhe a palavra de 5 letras. \n"
